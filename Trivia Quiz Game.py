...
while endGame != "quit":
    ...
    if (r.status_code != 200):
        endGame = input("Sorry, there was a problem retreiving the question. Press enter to try again or type 'quit' to quit'")
    else:
        valid_answer = False
        answer_number = 1 
        ...
        if user_answer == correct_answer:
            ...
            print("Sorry, " + html.unescape(user_answer)+ "is incorrect answer. The corrct answer is " + html.unescape(correct_answer))
            score_incorrect = 1
